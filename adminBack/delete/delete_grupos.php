...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id'])) {
        ...
        $sql_update = "UPDATE compostos SET grupo_funcional_id = NULL WHERE grupo_funcional_id = ?";
        ...
        // Deletar a entrada na tabela `grupos_funcionais`
        $sql_delete = "DELETE FROM grupos_funcionais WHERE id = ?";
        ...
        if ($stmt_delete->execute()) {
            header("Location: ../../adminFront/listCadastros/list_grupos.php?message=Grupo deletado com sucesso!");
            exit();
        } else {
    ...
    header("Location: ../../adminFront/listCadastros/list_grupos.php?message=Método de solicitação inválido");
    exit();
}
