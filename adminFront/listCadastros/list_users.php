...
<body>
    <header>
        <div class="card">
            ...
            <div class="card-body">
                <a class="nav-link active" aria-current="page" href="../users.php">Cadastrar Usúarios</a>
            </div>
        </div>
    </header>
    <main class="container">
        ...
        <?php if (!empty($dados_user)): ?>
            <?php foreach($dados_user as $retorno): ?>
                <div class="row mt-4 rounded m-2 p-2 d-flex border">
                    <div class="col"><?php echo $retorno['id']; ?></div>
                    <div class="col"><?php echo $retorno['nome']; ?></div>
                    <div class="col"><?php echo $retorno['email']; ?></div>
                    <div class="col"><?php echo $retorno['tipo']; ?></div>
                    <div class="col">
                        <a href="../edit/edit_users.php?id=<?php echo $retorno['id']; ?>" class="btn btn-success">Update</a>
                    </div>

                    <div class="col">
                        <form action="../../adminBack/delete/delete_users.php" method="post" onsubmit="return confirm('Tem certeza que deseja excluir este grupo?');">
